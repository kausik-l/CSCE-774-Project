...
def evaluate_model():
    ...
    evaluation_protocols = STACKING2_BENCHMARK['evaluation_protocols']
    ...
    scores = evaluator.evaluate_policy(policy_fn, fraction=0.2)
    evaluator.save_scores(log_relative_path)
    experiments = {'stacking2_model': scores}
